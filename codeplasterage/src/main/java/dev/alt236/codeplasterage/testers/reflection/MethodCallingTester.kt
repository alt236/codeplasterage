...
import dev.alt236.codeplasterage.reflection.methodcalling.CallResult
import dev.alt236.codeplasterage.reflection.methodcalling.CallableMethod
...
internal class MethodCallingTester(
    ...
    private fun <T> test(
        ...
        return when (callableMethod) {
            ...
            is CallableMethod.InstanceMethod ->
                when (val result = instantiator.instantiate(callableMethod.clazz)) {
